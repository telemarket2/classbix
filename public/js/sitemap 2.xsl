			...
			<body>
				...
				<div id="intro">
					<p>
						...
						It was generated using the Classifieds-Software <a href="http://classibase.com/">ClassiBase</a>.<br />
				...
				<div id="footer">
					Generated with <a href="http://classibase.com/" title="Classifieds-Software">ClassiBase</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
