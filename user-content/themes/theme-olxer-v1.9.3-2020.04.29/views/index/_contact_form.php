<form action="" method="post" id="contact_form">
	<h3 class="widget_title"><?php echo __('Contact {name}', array('{name}' => View::escape(User::getNameFromUserOrEmail($ad->User, $ad->email)))) ?></h3>
	<p class="extra_text"><?php echo __('about "{name}"', array('{name}' => View::escape(Ad::getTitle($ad)))) ?></p>
